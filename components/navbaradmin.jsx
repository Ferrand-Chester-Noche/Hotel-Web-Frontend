  ...
  return (
    ...
    <div className="fixed top-0 left-0 w-full">
      ...
      <nav style={{ backgroundColor: '#f6cdc9' }}>
        <div className="px-11 py-3 mx-auto" style={{ marginLeft: '9px'}}>
          <div className="flex items-center">
            <ul className="flex flex-row font-medium mt-0 space-x-8 rtl:space-x-reverse text-m">
              ...
              <li>
              <Link href="/employeemgmt" className="relative text-m w-fit block after:block after:content-[''] after:absolute after:h-[3px] after:bg-[#E8EBFA] after:w-full after:scale-x-0 after:hover:scale-x-100 after:transition after:duration-300 after:origin-center" style={{color: '#7f5262' }}>Employees</Link>
              </li>
              <li>
              <Link href="/servicesmgmt" className="relative text-m w-fit block after:block after:content-[''] after:absolute after:h-[3px] after:bg-[#E8EBFA] after:w-full after:scale-x-0 after:hover:scale-x-100 after:transition after:duration-300 after:origin-center" style={{color: '#7f5262' }}>Services</Link>
              </li>
            </ul>
          </div>
        </div>
